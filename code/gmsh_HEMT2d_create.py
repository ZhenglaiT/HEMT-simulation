...
# add_gmsh_contact   (mesh="HEMT", gmsh_name="drain_contact_AlGaN",  region="AlGaN", name="drain_AlGaN", material="metal")
# add_gmsh_contact   (mesh="HEMT", gmsh_name="source_contact_AlGaN", region="AlGaN", name="source_AlGaN", material="metal")
# add_gmsh_contact   (mesh="HEMT", gmsh_name="drain_contact_GaN",  region="GaN", name="drain_GaN", material="metal")
# add_gmsh_contact   (mesh="HEMT", gmsh_name="source_contact_GaN", region="GaN", name="source_GaN", material="metal")
add_gmsh_contact   (mesh="HEMT", gmsh_name="drain_contact",  region="GaN", name="drain", material="metal")
add_gmsh_contact   (mesh="HEMT", gmsh_name="source_contact", region="GaN", name="source", material="metal")
...
add_gmsh_interface (mesh="HEMT", gmsh_name="AlGaN_GaN", region0="AlGaN", region1="GaN", name="AlGaN_GaN")

finalize_mesh(mesh="HEMT")
create_device(mesh="HEMT", device="HEMT")

node_model(name="Donors",    device=device, region="AlGaN", equation="2e18")
...
node_model(name="Donors",    device=device, region="GaN", equation="1e13")
